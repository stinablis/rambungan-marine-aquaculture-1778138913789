...
const basePath = '/rambungan-marine-aquaculture-1778138913789';
...
export default function Home() {
  ...
  const submit = (e: any) => {
    ...
    window.open(`https://wa.me/60198526536?text=${msg}`, '_blank');
  };
  ...
  const products = [{ n: 'Fresh Goliath Grouper', d: 'Premium fresh Goliath Grouper sourced directly from our marine farm. Priced at RM300/kg.', i: 'https://lh3.googleusercontent.com/d/1CM66O1oCyNjkeF2JU1DvfCyeLaT2AK6v', icon: 'domain' }, { n: 'Seabass', d: 'Fresh locally farmed seabass, sustainably raised in Sungai Rambungan coastal waters.', i: 'https://lh3.googleusercontent.com/d/1y50_nph05Hi0YvuoTQrvaehpX00kxwQZ', icon: 'architecture' }, { n: 'Hatchery Services', d: 'Fish farming and hatchery projects serving both local and export markets.', i: 'https://images.pexels.com/photos/7509424/pexels-photo-7509424.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Site Management', d: 'Farm management support to improve efficiency, productivity, and regulatory compliance.', i: 'https://images.pexels.com/photos/18640095/pexels-photo-18640095.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Water Treatment Consultancy', d: 'Expert consultancy in water treatment plant management and environmental compliance.', i: 'https://images.pexels.com/photos/19888251/pexels-photo-19888251.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <img src="https://lh3.googleusercontent.com/d/1wJZAB9QfgnQEjWnJQZSYnCU5W4bZaD5e" alt="Rambungan Marine Aquaculture" className="h-10 w-auto object-contain scale-[1.5] origin-left" />
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://lh3.googleusercontent.com/d/189vLHFRJwR3i4iD2zxc4vbG5XMNRdDat" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Hatchery | Site <span className="text-accent">Management | Consultant | Education.</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Rambungan Marine Aquaculture delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60198526536`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Rambungan Marine Aquaculture, we are passionate about growing quality seafood while supporting a sustainable future. Since 2011, we have been developing fish farming and hatchery projects that serve both local and export markets. Working hand-in-hand with government bodies and industry partners, we help aquaculture businesses—especially small and medium players—grow, improve, and succeed.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be a leading and trusted aquaculture company in Malaysia, recognized for delivering sustainable, high-quality marine products while contributing to the growth, innovation, and global competitiveness of the aquaculture industry.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver high-quality, sustainable marine products and expert aquaculture services that exceed customer expectations, while promoting environmentally responsible practices and contributing to the long-term growth and development of the aquaculture industry.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Sustainability</h4>
                  <p className="text-sm text-on-surface-variant">Environmentally responsible farming methods that protect marine ecosystems for the long term.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Quality</h4>
                  <p className="text-sm text-on-surface-variant">Premium seabass and grouper that meet both domestic and international standards.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://lh3.googleusercontent.com/d/1ByVsv_m2LcH8H2YdvZKqFqYjiLVv0JYJ" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://lh3.googleusercontent.com/d/16EVBTdO6n0SoQiw5DMyEZ4DNpm2k3sXQ" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://lh3.googleusercontent.com/d/1v4SN5gS6A0eyQuc5HiFUx__cxtEWjPPY" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">rmasangkar@gmail.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">60198526536</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Rambungan Marine Aquaculture</div>
            <p className="text-white/60 text-sm leading-relaxed">Hatchery | Site Management | Consultant | Education</p>
          </div>
          <div className="flex justify-center md:justify-center gap-6">
            <a href="https://www.facebook.com/RambunganMarine" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">Facebook</a>
            
            <a href={`https://wa.me/60198526536`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              © {new Date().getFullYear()} Rambungan Marine Aquaculture. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
